from trans.module2 import TransLate,LangDetect,LanguageList,CodeLang
...
print("_____________________The program is working with module 2________________________")
